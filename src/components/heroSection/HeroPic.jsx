  ...
  return (
    ...
    >
      <div className="relative flex items-center justify-center w-[320px] h-[360px] md:w-[400px] md:h-[460px]">
        ...
        >
          <PiHexagonThin className="h-[190%] w-[190%] animate-spin-slow text-accent/95 mix-blend-screen drop-shadow-[0_0_40px_rgb(var(--glow-primary)/0.95)]" />
        </div>
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 z-20 flex items-center justify-center"
        >
          <PiHexagonThin className="h-[150%] w-[150%] animate-spin-slow-reverse text-accent-2/80 mix-blend-screen drop-shadow-[0_0_28px_rgb(var(--glow-secondary)/0.7)]" />
        </div>
        <div className="relative z-10 overflow-hidden rounded-[80px] ring-2 ring-accent/80 shadow-[0_0_50px_rgb(var(--glow-primary)/0.55)]">
          <img
            ...
            alt="Mufaddal Calcuttawala — Full-Stack Developer"
